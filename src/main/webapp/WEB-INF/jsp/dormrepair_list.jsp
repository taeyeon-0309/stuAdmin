...
<%--                <td>${di.d_dormbuilding}</td>--%>
                <td>${di.r_name}</td>
                <td>${di.reason}</td>
                <td><fmt:setTimeZone value="UTC-8" /><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${di.create_time}"/></td>
                <td><fmt:setTimeZone value="UTC-8" /><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${di.update_time}"/></td>
                <td>
